package com.example.karads.latihanrecyclerview;
...
import com.example.karads.latihanrecyclerview.model.President;

import java.util.ArrayList;

/**
 * Created by karads on 1/8/2018.
 */
...
public class GridPresidentAdapter extends RecyclerView.Adapter<GridPresidentAdapter.GridViewHolder> {
    ...
    public class GridViewHolder extends RecyclerView.ViewHolder{
        ...
        public GridViewHolder(View itemView) {
            super(itemView);
            imgPhoto = (ImageView)itemView.findViewById(R.id.img_item_photo_grid);
        }
    }
}
